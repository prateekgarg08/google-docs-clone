...
const AuthLayout = ({ children }: Props) => {
  return (
    <main className="min-h-screen flex flex-col items-center w-full px-5">
      <div className="flex flex-col items-center grow md:pt-12 w-full max-w-md">
        <div className="rounded-xl md:border grow border-1 w-full flex flex-col items-center pt-10">
          <svg
            viewBox="0 0 75 24"
            width="75"
            height="24"
        ...
        <footer className="flex flex-col sm:flex-row justify-between w-full  text-sm">
          <div className="py-5">English</div>
          <div className="py-5">
